...
@section('content-admin')
        <div class="pannel">
            <div class="pannel-title">
                ...
                <li><a href="{{URL::to('admin/categories/')}}" title="admin/news">@lang('component.categories_news_list')</a></li>
            </div>
                        ...
                        <ul class="nav nav-tabs">
                            <li>
                                <a class="active show" data-toggle="tab" href="#list">
                                    <i class="fas fa-clipboard-list"></i>@lang('component.categories_news_list')</a>
                            </li>
                            <li>
                              ...
                              <div class="tab-content">
                                <div id="list" class="tab-pane fade in active show">
                                    <table id="listtable" class="table table-bordered table-striped">
                                        <thead>
                                        <th>@lang('component.categories_news_title')</th>
                                        <th>@lang('component.categories_news_description')</th>
                                        <th>@lang('component.categories_news_keyword')</th>
                                        <th>Tags</th>
                                        <th></th>
                                        </thead>
                                        <tbody>
                                ...
                                <div id="trash" class="tab-pane fade">
                                    <table id="trashtable" class="table table-bordered table-striped">
                                        ...
                                        <th>@lang('component.categories_news_keyword')</th>
                                        <th>Tags</th>
                                        <th>@lang('component.categories_news_language')</th>
                                        <th></th>
                                        </thead>
                                        <tbody>
                                        </tbody>
                ...
                var method =
                    {
                        ...
                        selectedId: false,
                        sortField :[
                            "@lang('component.categories_news_title')",
                            "@lang('component.categories_news_description')",
                            "@lang('component.categories_news_keyword')",
                            "@lang('component.categories_news_language')"
                        ]
                    }
