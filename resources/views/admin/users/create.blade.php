...
@section('content-admin')
    <div class="pannel">
        <div class="pannel-title">
            <div class="current-page">@lang('component.news_create_title')</div>
        ...
        <form class="form-basic" action="{{URL::to('admin/news/create')}}" method="POST">
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="enter content" id="contents" name="contents"></textarea>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-info">@lang('button.news_create')</button>
                            </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <ul child-tab="basic">
                                            <div class="form-tab">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control unline" id="link1" name="link1">
                                                    <span>link image size 1200px x 300px</span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="link2">Link 2:</label>
                                                    <input type="text" class="form-control unline" id="link2" name="link2">
                                                    <span>link image size 80px x 900px</span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="link3">Link 3:</label>
                                                    <input type="text" class="form-control unline" id="link3" name="link3">
                                        ...
                                        <ul child-tab="advanced">
                                            <div class="form-tab">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control unline" id="publish" name="publish">
                                                </div>
                                                <div class="form-group">
                                                    <label for="link2">@lang('component.news_status')</label>
                                                    <input type="text" class="form-control unline" id="status" name="status">
                                                </div>
                                            </div>
                                        </ul>
                                    </li>
