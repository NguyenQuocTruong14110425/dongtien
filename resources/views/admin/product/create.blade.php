...
@section('content-admin')
        <div class="pannel">
            <div class="pannel-title">
                 <div class="current-page">@lang('component.product_create_title')</div>
        ...
        @endif
        <form class="form-basic" action="{{URL::to('admin/product/create')}}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="row">
